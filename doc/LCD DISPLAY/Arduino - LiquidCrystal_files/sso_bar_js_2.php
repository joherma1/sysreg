...
function ssoGenerateLoginBar() {
  ...
  $r += '<div class="lo sep">|</div> ';
  $r += '<div class="lo"><a href="https://id.arduino.cc/auth/login/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FTutorial%2FLiquidCrystal">Sign in</a> or ';
  $r += '<a href="https://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FTutorial%2FLiquidCrystal">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
